package org.jaulp.wicket.components.termofuse.dataprotection;
...
public class DataProtectionPanel extends HeaderContentListPanel {
	...
	public DataProtectionPanel(String id) {
		this(id, null);
	}

	public DataProtectionPanel(String id, IModel<HeaderContentListModel> model) {
		super(id, model);
	}
