...
public class LocalizedDropdownChoicePanel<T> extends
	...
	public LocalizedDropdownChoicePanel(String id, IModel<T> model,
			IModel<String> labelModel, List<T> enumValues) {
		super(id, model, labelModel);

		dropdownChoice = new LocalisedDropDownChoice<T>("dropdownChoice",
				model, enumValues);
		add(dropdownChoice);
