package de.alpharogroup.wicket.components.termofuse.fulfilmentandjurisdiction;
...
public class FulfilmentAndJurisdictionPlacePanel extends HeaderContentListPanel
{
	...
	public FulfilmentAndJurisdictionPlacePanel(String id)
	{
		this(id, null);
	}

	public FulfilmentAndJurisdictionPlacePanel(String id, IModel<HeaderContentListModel> model)
	{
		super(id, model);
	}
