...
public class StringTextValue<T> {
   ...
   *
   * @param quotationMarkType the quotation mark type
   ...
   *
   * @param name the name
   * @param stringTextType the string text type
   */
...
public StringTextValue(final String name, final T value, StringTextType stringTextType, boolean defaultValue) {
