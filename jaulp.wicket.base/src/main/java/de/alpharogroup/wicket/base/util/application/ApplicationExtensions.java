...
public final class ApplicationExtensions
{
	 ...
	 *             {@link ApplicationExtensions#setDeploymentModeConfiguration(Application)}
	 */
	@Deprecated
		...
		final AbstractRequestCycleListener applicationRequestCycleListener)
	{
		...
		{
			ApplicationExtensions.setExceptionSettingsForDeployment(application,
	 ...
	 * @deprecated use instead
	 *             {@link ApplicationExtensions#setHeaderResponseDecorator(Application, String)}
	 */
	@Deprecated
