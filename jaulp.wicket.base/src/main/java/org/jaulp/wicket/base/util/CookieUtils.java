...
public final class CookieUtils {
	 ...
	 *
	 * @param cookie the cookie to clear.
	 */
	 ...
	 * @return the cookie
	 */
	public static Cookie newCookie(String name, String value, String purpose, String domain,  int maxAge, String path, boolean secure) {
