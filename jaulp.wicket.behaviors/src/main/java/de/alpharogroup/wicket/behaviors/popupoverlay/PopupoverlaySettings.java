...
public class PopupoverlaySettings implements Settings
{
	...
	private static final long serialVersionUID = 1L;
	   ...
	   * Default: overlay
	   */
	  private StringTextValue<PopupoverlayType> type = new StringTextValue<PopupoverlayType>("type", PopupoverlayType.OVERLAY, StringTextType.ENUM);

	  /**
	   * Shows the popup when initialized.
	   * Default: false
	   */
	  private StringTextValue<Boolean> autoopen = new StringTextValue<Boolean>("autoopen", StringTextType.BOOLEAN);

	  /**
	   * Disables scrolling of background content while the popup is visible.
	   * Default: false
	   */
	  private StringTextValue<Boolean> scrolllock = new StringTextValue<Boolean>("scrolllock", StringTextType.BOOLEAN);

	  /**
	   * Enables background cover. Disabled for tooltips.
	   * Default: true
	   */
	  private StringTextValue<Boolean> background = new StringTextValue<Boolean>("background", true, StringTextType.BOOLEAN);
	   ...
	   * Default: false
	   */
	  private StringTextValue<Boolean> backgroundactive = new StringTextValue<Boolean>("backgroundactive", StringTextType.BOOLEAN);

	  /**
	   * Sets background color.
	   * Default: #000
	   */
	  private StringTextValue<String> color = new StringTextValue<String>("color", "#000", StringTextType.STRING);

	  /**
	   * The opacity of the notice.
	   * Default: 1
	   */
	  private StringTextValue<Float> opacity = new StringTextValue<Float>("opacity", 0.5f, StringTextType.FLOAT);
	   ...
	   * Default: center
	   */
	  private StringTextValue<HorizontalPosition> horizontal = new StringTextValue<HorizontalPosition>("horizontal", HorizontalPosition.CENTER, StringTextType.ENUM);

	  /**
	   * Sets vertical position. Options `topedge` and `bottomedge` can be used only for tooltips, and will align the tooltip
	   * to the top or bottom edge of the opening element (`openelement`).
	   * Default: center
	   */
	  private StringTextValue<VerticalPosition> vertical = new StringTextValue<VerticalPosition>("vertical", VerticalPosition.CENTER, StringTextType.ENUM);

	  /**
	   * Sets top offset to tooltip or overlay.
	   * Default: 0
	   */
	  private StringTextValue<Integer> offsettop = new StringTextValue<Integer>("offsettop", 0, StringTextType.INTEGER);

	  /**
	   * Sets left offset to tooltip or overlay.
	   * Default: 0
	   */
	  private StringTextValue<Integer> offsetleft = new StringTextValue<Integer>("offsetleft", 0, StringTextType.INTEGER);

	  /**
	   * Closes the popup when Escape key is pressed.
	   * Default: true
	   */
	  private StringTextValue<Boolean> escape = new StringTextValue<Boolean>("escape", true, StringTextType.BOOLEAN);

	  /**
	   * Closes the popup when clicked outside of it.
	   * Default: true
	   */
	  private StringTextValue<Boolean> blur = new StringTextValue<Boolean>("blur", true, StringTextType.BOOLEAN);

	  /**
	   * Sets default z-index to the popup (2001) and to the background (2000).
	   * Default: true
	   */
	  private StringTextValue<Boolean> setzindex = new StringTextValue<Boolean>("setzindex", true, StringTextType.BOOLEAN);

	  /**
	   * Sets highest z-index on the page to the popup.
	   * Default: false
	   */
	  private StringTextValue<Boolean> autozindex = new StringTextValue<Boolean>("autozindex", StringTextType.BOOLEAN);

	  /**
	   * Lock keyboard focus inside of popup. Recommended to be enabled.
	   * Default: true
	   */
	  private StringTextValue<Boolean> keepfocus = new StringTextValue<Boolean>("keepfocus", true, StringTextType.BOOLEAN);

	  /**
	   * Enables you to specify the element which will be focused upon showing the popup. By default,
	   * the popup element #my_popup will receive the initial focus.
	   * Default: my_popup
	   */
	  private StringTextValue<String> focuselement = new StringTextValue<String>("focuselement", StringTextType.STRING);
	   ...
	   * Default: 50
	   */
	  private StringTextValue<Integer> focusdelay = new StringTextValue<Integer>("focusdelay", 50, StringTextType.INTEGER);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> pagecontainer = new StringTextValue<String>("pagecontainer", StringTextType.STRING);
	   ...
	   * Default: false
	   */
	  private StringTextValue<Boolean> outline = new StringTextValue<Boolean>("outline", StringTextType.BOOLEAN);

	  /**
	   * Removes popup element from the DOM after closing transition.
	   * Default: false
	   */
	  private StringTextValue<Boolean> detach = new StringTextValue<Boolean>("detach", StringTextType.BOOLEAN);

	  /**
	   * Enables you to define custom element which will open the popup on click.
	   * Default: .{popup_id}_open
	   */
	  private StringTextValue<String> openelement = new StringTextValue<String>("openelement", StringTextType.STRING);

	  /**
	   * Enables you to define custom element which will close the popup on click.
	   * Default: .{popup_id}_close
	   */
	  private StringTextValue<String> closeelement = new StringTextValue<String>("closeelement", StringTextType.STRING);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> transition = new StringTextValue<String>("transition", StringTextType.STRING);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> tooltipanchor = new StringTextValue<String>("tooltipanchor", StringTextType.STRING);

	  /**
	   * Type: function Description: Callback function which will execute before the popup is opened.
	   * Default: not set
	   */
	  private StringTextValue<String> beforeopen = new StringTextValue<String>("beforeopen", StringTextType.STRING);

	  /**
	   * Type: function Description: Callback function which will execute when the popup starts to open.
	   * Default: not set
	   */
	  private StringTextValue<String> onopen = new StringTextValue<String>("onopen", StringTextType.STRING);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> onclose = new StringTextValue<String>("onclose", StringTextType.STRING);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> opentransitionend = new StringTextValue<String>("opentransitionend", StringTextType.STRING);
	   ...
	   * Default: not set
	   */
	  private StringTextValue<String> closetransitionend = new StringTextValue<String>("closetransitionend", StringTextType.STRING);
