...
public class TooltipsterSettings implements Settings {
  ...
  /**
	 ...
	 */
	private StringTextValue<String> animation = new StringTextValue<String>("animation", "fade",  StringTextType.STRING);

	/**
	 * Adds the "speech bubble arrow" to the tooltip. Default: true
	 */
  private StringTextValue<Boolean> arrow = new StringTextValue<Boolean>("arrow", true, StringTextType.BOOLEAN);
	 ...
	 * hex code / rgb
	 */
  private StringTextValue<String> arrowColor = new StringTextValue<String>("arrowColor", StringTextType.STRING);

	/**
	 * If autoClose is set to false, the tooltip will never close unless you call the 'hide' method yourself. Default: true
	 */
  private StringTextValue<Boolean> autoClose = new StringTextValue<Boolean>("autoClose", true, StringTextType.BOOLEAN);

	/**
	 * If set, this will override the content of the tooltip. Default: null
	 */
  private StringTextValue<String> content = new StringTextValue<String>("content", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> contentAsHTML = new StringTextValue<Boolean>("contentAsHTML", StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<Boolean> contentCloning = new StringTextValue<Boolean>("contentCloning", true, StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<Boolean> debug = new StringTextValue<Boolean>("debug", true, StringTextType.BOOLEAN);

	/**
	 * Delay how long it takes (in milliseconds) for the tooltip to start animating in. Default: 200
	 */
  private StringTextValue<Integer> delay = new StringTextValue<Integer>("delay", 200, StringTextType.INTEGER);

	/**
	 * Set a minimum width for the tooltip. Default: 0 (auto width)
	 */
  private StringTextValue<Integer> minWidth = new StringTextValue<Integer>("minWidth", 0, StringTextType.INTEGER);

	/**
	 * Set a maximum width for the tooltip. Default: null (no max width)
	 */
  private StringTextValue<String> maxWidth = new StringTextValue<String>("maxWidth", StringTextType.STRING_INTEGER);
	 ...
	 */
  private StringTextValue<String> functionInit = new StringTextValue<String>("functionInit", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<String> functionBefore = new StringTextValue<String>("functionBefore", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<String> functionReady = new StringTextValue<String>("functionReady", StringTextType.STRING);

	/**
	 * Create a custom function to be fired once the tooltip has been closed and removed from the DOM. Default: function(origin) {}
	 */
  private StringTextValue<String> functionAfter = new StringTextValue<String>("functionAfter", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> hideOnClick = new StringTextValue<Boolean>("hideOnClick", StringTextType.BOOLEAN);

	/**
	 * If using the iconDesktop or iconTouch options, this sets the content for your icon. Default: '(?)'
	 */
  private StringTextValue<String> icon = new StringTextValue<String>("icon", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> iconCloning = new StringTextValue<Boolean>("iconCloning", true, StringTextType.BOOLEAN);

	/**
	 * Generate an icon next to your content that is responsible for activating the tooltip on non-touch devices. Default: false
	 */
  private StringTextValue<Boolean> iconDesktop = new StringTextValue<Boolean>("iconDesktop", StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<String> iconTheme = new StringTextValue<String>("iconTheme", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> iconTouch = new StringTextValue<Boolean>("iconTouch", StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<Boolean> interactive = new StringTextValue<Boolean>("interactive", StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<Integer> interactiveTolerance = new StringTextValue<Integer>("interactiveTolerance", 350, StringTextType.INTEGER);

	/**
	 * Allows you to put multiple tooltips on a single element. Read further instructions down this page. Default: false
	 */
  private StringTextValue<Boolean> multiple = new StringTextValue<Boolean>("multiple", StringTextType.BOOLEAN);

	/**
	 * Offsets the tooltip (in pixels) farther left/right from the origin. Default: 0
	 */
  private StringTextValue<Integer> offsetX = new StringTextValue<Integer>("offsetX", 0, StringTextType.INTEGER);

	/**
	 * Offsets the tooltip (in pixels) farther up/down from the origin. Default: 0
	 */
  private StringTextValue<Integer> offsetY = new StringTextValue<Integer>("offsetY", 0, StringTextType.INTEGER);
	 ...
	 */
  private StringTextValue<Boolean> onlyOne = new StringTextValue<Boolean>("onlyOne", StringTextType.BOOLEAN);

	/**
	 * Set the position of the tooltip. Default: 'top'
	 */
  private StringTextValue<String> position = new StringTextValue<String>("position", "top", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> positionTracker = new StringTextValue<Boolean>("positionTracker", StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<String> positionTrackerCallback = new StringTextValue<String>("positionTrackerCallback", null, StringTextType.STRING);
	 ...
	 */
  private StringTextValue<String> restoration = new StringTextValue<String>("restoration", "current", StringTextType.STRING);

	/**
	 * Set the speed of the animation. Default: 350
	 */
  private StringTextValue<Integer> speed = new StringTextValue<Integer>("speed", 350, StringTextType.INTEGER);

	/**
	 * How long the tooltip should be allowed to live before closing. Default: 0 (disabled)
	 */
  private StringTextValue<Integer> timer = new StringTextValue<Integer>("timer", 0, StringTextType.INTEGER);

	/**
	 * Set the theme used for your tooltip. Default: 'tooltipster-default'
	 */
  private StringTextValue<String> theme = new StringTextValue<String>("theme", "tooltipster-default", StringTextType.STRING);
	 ...
	 */
  private StringTextValue<Boolean> touchDevices = new StringTextValue<Boolean>("touchDevices", true, StringTextType.BOOLEAN);
	 ...
	 */
  private StringTextValue<String> trigger = new StringTextValue<String>("trigger", "hover", StringTextType.STRING);

	/**
	 * If a tooltip is open while its content is updated, play a subtle animation when the content changes. Default: true
	 */
  private StringTextValue<Boolean> updateAnimation = new StringTextValue<Boolean>("updateAnimation", true, StringTextType.BOOLEAN);
