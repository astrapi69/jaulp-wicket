...
public class PnotifyJsGenerator implements Serializable {
  ...
  /** The {@link org.apache.wicket.request.resource.ResourceReference} constant for the js and css-file from the Pnotify. */
   ...
   */
  public String generateJavascriptTemplateContent(final Map<String, Object> variables, String methodName) {
