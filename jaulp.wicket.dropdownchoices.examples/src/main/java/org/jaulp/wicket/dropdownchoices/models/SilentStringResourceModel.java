...
public class SilentStringResourceModel extends StringResourceModel {
     ...
     */
    public SilentStringResourceModel( final String resourceKey,
    ...
    public SilentStringResourceModel( final String resourceKey,
            final Component component, final IModel< ? > model,
            final Object [] parameters, final Locale locale ) {
     ...
     */
    protected Properties getResource( final Class< ? > componentClass,
            final Class< ? > defaultClass, final String resourceKey )
            throws Exception {
        // Try to find the properties file and the resource
        Properties properties = null;
        if ( componentClass != null ) {
            properties = PropertiesUtils.loadPropertiesFromClassObject(
                    componentClass, locale );
        } else {
            properties = PropertiesUtils.getLocalPropertiesFromClass(
                    componentClass, defaultClass, locale );
        }
        return properties;
    }
     ...
     * @return the resource
     */
    protected String getResource( final Component component,
            final Class< ? > componentClass, final String resourceKey ) {
        String result = null;
        // Try to find the properties file and the resource
        Properties properties = null;
        try {
    ...
    protected String getFromResourceBundle() {
        ...
        try {
            if ( component != null ) {
                resourceBundle = ResourceBundle.getBundle( component.getClass()
                        .getName(), locale );
            } else if ( componentClass != null ) {
                resourceBundle = ResourceBundle.getBundle(
                        componentClass.getName(), locale );
            }
